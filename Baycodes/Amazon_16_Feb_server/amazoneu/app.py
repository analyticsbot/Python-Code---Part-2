                ...
                if t.index(i) ==2:
                    ...
                    if t.index(i) == t[9]:
                        tableString += unidecode('''<td style='text-align:center;vertical-align:middle' height="50" bgcolor="#66CDAA"
                                    > <a href="http://www.amazon.co.uk/dp/'''+str(t[0])+'''"><i>''' +returnPrice(i)+'''</i></a></td>''')
                    else:
                    ...
                    if t.index(i) == t[9]:
                        tableString += unidecode('''<td style='text-align:center;vertical-align:middle' height="50" bgcolor="#66CDAA"
                                    > <a href="http://www.amazon.fr/dp/'''+str(t[0])+'''"><i>''' +returnPrice(i)+'''</i></a></td>''')
                    else:
                        tableString += unidecode('''<td style='text-align:center;vertical-align:middle' height="50" >
                                        <a href="http://www.amazon.co.uk/dp/'''+str(t[0])+'''"><i>''' +returnPrice(i)+'''</i></a></td>''')
                elif t.index(i) ==6:
                    if t.index(i) == t[9]:
                        tableString += unidecode('''<td style='text-align:center;vertical-align:middle' height="50" bgcolor="#66CDAA"
                                    > <a href="http://www.amazon.it/dp/'''+str(t[0])+'''"><i>''' +returnPrice(i)+'''</i></a></td>''')
                    else:
                        tableString += unidecode('''<td style='text-align:center;vertical-align:middle' height="50" >
                                        <a href="http://www.amazon.it/dp/'''+str(t[0])+'''"><i>''' +returnPrice(i)+'''</i></a></td>''')
                elif t.index(i) ==7:
                    if t.index(i) == t[9]:
                        tableString += unidecode('''<td style='text-align:center;vertical-align:middle' height="50" bgcolor="#66CDAA"
                                    > <a href="http://www.amazon.es/dp/'''+str(t[0])+'''"><i>''' +returnPrice(i)+'''</i></a></td>''')
                    else:
                        tableString += unidecode('''<td style='text-align:center;vertical-align:middle' height="50" >
                                        <a href="http://www.amazon.es/dp/'''+str(t[0])+'''"><i>''' +returnPrice(i)+'''</i></a></td>''')
                else:
