...
class AdwordsAutomater(object):
    ...
    def login(self):
        ...
        try:
            ...
            pass
        self.ff.find_element_by_class_name('ignore-channel').click()
        self.ff.find_element_by_id("Email").send_keys(email)
        self.ff.find_element_by_id('next').click()
...
if __name__ == "__main__":
    aa = AdwordsAutomater(email="ivar.dodo123@gmail.com", passwd="ravihari!12")
