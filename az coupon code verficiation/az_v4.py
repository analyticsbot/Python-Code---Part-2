...
class AZCoupons:
    ...
    def verifyCoupon(self, asin, coupon, discount):
        ...
        if addToCart !=None:
            ...
            self.getElement('address-book-entry-2', 'id').find_element_by_class_name('a-button-inner').click()
            time.sleep(random.randint(1,3))   
            self.getElement('a-button-inner', 'class').click()
            time.sleep(random.randint(1,3))   
...
def main(asin, coupon, discount):
    ...
    if args.trigger is not None:
        ...
        status, text = az.verifyCoupon('B012X7ML36', 'EBJQ-GQ5UHX-Q4NL83', 6)
